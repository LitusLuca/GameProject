...
void State_Intro::onCreate()
{
	...
	m_stateManager->getContext()->m_textureManager->requireResource(m_introTexture);
	sf::Texture* introTexture = m_stateManager->getContext()->m_textureManager->getResource(m_introTexture);
...
void State_Intro::onDestroy()
{
	...
	m_stateManager->getContext()->m_textureManager->releaseResource(m_introTexture);
}
